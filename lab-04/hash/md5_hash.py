...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            d = c
            c = b
            # Lưu ý: Dòng dưới đây được chép y nguyên từ hình ảnh bạn cung cấp
            # Trong thuật toán MD5 chuẩn, các giá trị 0x5A827999 và 3 thường được thay thế 
            # bằng bảng hằng số K[j] và độ dịch s[j] thay đổi theo mỗi vòng lặp.
